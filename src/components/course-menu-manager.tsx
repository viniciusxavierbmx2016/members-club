        ...
        <div className="mt-4 bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-xl p-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-[var(--producer-button-text,#ffffff)] text-sm font-medium rounded-lg transition"
            >
              Adicionar
            </button>
            <button
  ...
  return (
    <div className="relative">
      <select
        ...
        className="pl-10 pr-8 py-2 bg-white dark:bg-[#202020]/50 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white appearance-none focus:outline-none focus:border-blue-500/50 transition-colors"
      >
