      ...
      >
        ...
        <div className="flex gap-2 mt-5">
          ...
          <button
            ...
            onClick={resgatar}
            disabled={resgatando}
            className="flex-1 px-4 py-2.5 text-sm font-medium rounded-lg bg-emerald-600 hover:bg-emerald-700 text-[var(--member-button-text,#0a0a0a)] disabled:opacity-60"
          >
