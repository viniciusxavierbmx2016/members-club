  ...
  return (
    <div className="relative">
      <select
        ...
        className="pl-10 pr-8 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white appearance-none focus:outline-none focus:border-primary/50 transition-colors"
      >
